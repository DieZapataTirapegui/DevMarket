    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center gap-5 px-4">
        ...
        <div className="text-center">
          <h2 className="text-white text-xl font-bold">Tu carrito te espera</h2>
          <p className="text-slate-400 text-sm mt-1">Ingresá para ver tus productos</p>
        </div>
        <Link
          to="/login"
  ...
  if (isError || !cart || cart.items.length === 0) {
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center gap-5 px-4">
        ...
        <div className="text-center">
          <h2 className="text-white text-xl font-bold">Tu carrito está vacío</h2>
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center gap-5 px-4">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm mt-1">Redirigiendo a tus pedidos...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold text-white tracking-tight">Carrito</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-w-0 gap-1">
                  <Link
                    ...
                    className="text-white text-sm font-semibold leading-snug line-clamp-2 hover:text-indigo-300 transition-colors"
                  >
                    {item.product.title}
                  </Link>
        ...
        >
          ...
          <div className="border-t border-slate-700/50 mt-5 pt-5">
            ...
            <Link
              to="/products"
              className="flex items-center justify-center gap-2 text-slate-400 hover:text-white text-sm mt-4 transition-colors"
            >
              Seguir comprando
            </Link>
          </div>
